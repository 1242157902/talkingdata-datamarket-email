 ...
 */
public class MailSenderGeneral {
    private static final Logger logger = LoggerFactory.getLogger(MailSenderGeneral.class);
    ...
    public String send(String sendTo, String subject, Map<String, Object> resultMap,String template)throws Exception {
        String content = getMailText(resultMap, template);
        Mail mail = new Mail();
    ...
    public static void main(String[] args)throws Exception{
        ...
        MailSenderGeneral sender = (MailSenderGeneral)context.getBean("mailSender");
        Map<String, Object> resultMap = new HashMap<String, Object>();
        resultMap.put("start", "20141001");
        resultMap.put("end", "20141007");
        resultMap.put("total_account",356);
        String str = sender.send("shuangliang.yang@tendcloud.com", "DataMarket 每周业务数据" + 20141001 + "~" + 20141007, resultMap,"report.ftl");
